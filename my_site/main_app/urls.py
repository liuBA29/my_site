...
urlpatterns = [
    ...
    path('ai-assistants/', ai_assistants, name='ai_assistants'),  # AI ассистенты
    path('custom-crm/', custom_crm, name='custom_crm'),  # Кастомные CRM
    path('desktop-apps/', desktop_apps, name='desktop_apps'),  # Десктопные приложения
